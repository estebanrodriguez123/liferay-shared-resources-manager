...
public abstract class AssetLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 */
	@Override
	public Asset fetchAssetByUuidAndCompanyId(String uuid, long companyId)
		throws SystemException {
		return assetPersistence.fetchByUuid_C_First(uuid, companyId, null);
	}
	 ...
	 */
	@Override
	public Asset getAssetByUuidAndCompanyId(String uuid, long companyId)
		throws PortalException, SystemException {
		return assetPersistence.findByUuid_C_First(uuid, companyId, null);
	}
	...
	public AssetPhotoBlobModel getPhotoBlobModel(Serializable primaryKey)
		...
		try {
			...
			return (com.rivetlogic.assetmanagement.model.AssetPhotoBlobModel)session.get(AssetPhotoBlobModel.class,
				primaryKey);
		}
		catch (Exception e) {
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.rivetlogic.assetmanagement.model.Asset",
			assetLocalService);
	}
