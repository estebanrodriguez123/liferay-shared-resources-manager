...
package com.rivetlogic.assetmanagement.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			AssetCategoryLocalServiceUtil.clearService();

			AssetLocationLocalServiceUtil.clearService();

			AssetMessageLocalServiceUtil.clearService();

			AssetRequestLocalServiceUtil.clearService();
		}
	}
}